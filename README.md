...
const REG_FEES = {
  ...
  '小学生：会員':      { label: '登録・保険（小学生：会員）',      annual: 2800 },
  '小学生：賛助会員B': { label: '登録・保険（小学生：賛助会員B）', annual: 3800 },
  '中学生：賛助会員B': { label: '登録・保険（中学生：賛助会員B）', annual: 4300 },
  '中学生：賛助会員A': { label: '登録・保険（中学生：賛助会員A）', annual: 7300 },
};
